...
router.get(
  ...
  userController.output.githubRepository
); //github repository list 가져오기
router.get(
  "/github/stack",
  middleWare.isAuthenticated,
  userController.output.githubStack
); //github tech stack list 가져오기
router.post(
  "/profile/:userId/github/stack",
  userController.process.githubStack
); //github tech stack list에서 선택 등록하기

// profile 정보 가져오기
router.get(
  "/profile/:userId",
  middleWare.loginMiddleWare,
  profileController.output.userProfile
);

// TechStack 수정
router.put(
  "/profile/techstack/:userId",
  middleWare.loginMiddleWare,
  profileController.process.editTechStack
);
...
router.post(
  ...
  middleWare.loginMiddleWare,
  profileController.process.editExperience
);
...
router.post(
  ...
  middleWare.loginMiddleWare,
  profileController.process.addEducation
);
router.put(
  "/profile/education/:userId",
  middleWare.loginMiddleWare,
  profileController.process.editEducation
);
...
router.post(
  ...
  middleWare.loginMiddleWare,
  profileController.process.editInterest
);
...
router.get(
  ...
  middleWare.loginMiddleWare,
  profileController.output.userEditProfile
);
router.put(
  "/profile/update",
  middleWare.loginMiddleWare,
  profileController.process.updateUserProfile
);

// Project
router.post(
  "/profile/projects/:userId",
  middleWare.loginMiddleWare,
  profileController.process.githubUserProjects
);
router.get("/project/:userId", projectController.output.projectList);
router.get(
  "project/:userId/:projectId",
  projectController.output.projectDetail
);
...
router.get(
  ...
  middleWare.loginMiddleWare,
  githubapi.getUserRepositoryList
);
...
router.get(
  "/:userId/lookAround",
  middleWare.loginMiddleWare,
  userController.output.lookAround
);
router.get("/search", userController.output.searchUser);

// Respect
router.post(
  "/profile/:respectUserId/:userId",
  middleWare.loginMiddleWare,
  userController.process.respect
);
